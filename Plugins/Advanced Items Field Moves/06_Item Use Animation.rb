...
def pbItemAnimation(item)
  ...
  sprite = ItemIconSprite.new(48, 48, item, viewport)
  sprite.setOffset(PictureOrigin::CENTER)
  #sprite.setItemBitmap(item)
...
def pbCallItemAnimation(item)
  if $PokemonSystem.animation_item == 0
    pbItemAnimation((item[:internal_name]))
  end
end

def pbCallMoveAnimation(pokemon)
  if $PokemonSystem.animation_move == 0
