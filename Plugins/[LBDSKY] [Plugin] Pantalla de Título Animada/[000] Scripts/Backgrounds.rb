...
class MTS_Element_BG0
  ...
  def initialize(viewport,file=nil)
    ...
    @sprites["bg"].bitmap = pbBitmap("Graphics/Titles/Backgrounds/#{file}")
  end
...
class MTS_Element_BG1
  ...
  def initialize(viewport,file=nil)
    ...
    # creates the background layer
    @sprites["bg"] = Sprite.new(@viewport)
    @sprites["bg"].bitmap = pbBitmap("Graphics/Titles/Backgrounds/digital")
    # analyzes background
    f = 16
    avg = 0
    n = 0
...
class MTS_Element_BG2
  ...
  def initialize(viewport,file=nil)
    ...
    @sprites["bg"].setBitmap("Graphics/Titles/Backgrounds/radiant")
    # creates the circular zoom patterns
    for i in 0...8
      @sprites["h#{i}"] = Sprite.new(@viewport)
      @sprites["h#{i}"].bitmap = pbBitmap("Graphics/Titles/Particles/ring001")
      @sprites["h#{i}"].center!
...
class MTS_Element_BG3
  ...
  def initialize(viewport,file=nil)
    ...
    @sprites["bg1"].bitmap = pbBitmap("Graphics/Titles/Backgrounds/clouded")
    @sprites["bg1"].center!
    ...
    @sprites["bg2"].bitmap = pbBitmap("Graphics/Titles/Particles/ring003")
    @sprites["bg2"].center!
...
class MTS_Element_BG4
  ...
  def initialize(viewport,file=nil)
    ...
    # creates the background layer
    @sprites["bg"] = Sprite.new(@viewport)
    @sprites["bg"].bitmap = pbBitmap("Graphics/Titles/Backgrounds/dusk")
    # creates glow
    @tog = 1
    @sprites["glow"] = Sprite.new(@viewport)
    @sprites["glow"].bitmap = pbBitmap("Graphics/Titles/Particles/glow001")
    # creates spinning element
    @sprites["rad"] = Sprite.new(@viewport)
    @sprites["rad"].bitmap = pbBitmap("Graphics/Titles/Particles/radial001")
...
class MTS_Element_BG5
  ...
  def initialize(viewport,file=nil)
    ...
    # creates the background layer
    @sprites["bg"] = RainbowSprite.new(@viewport)
    @sprites["bg"].setBitmap("Graphics/Titles/Backgrounds/rainbow")
  end
  # updates the background
  def update(skip=false)
    return if self.disposed?
...
class MTS_Element_BG6
  ...
  def initialize(viewport,file=nil)
    ...
    # creates the background layer
    @sprites["bg"] = Sprite.new(viewport)
    @sprites["bg"].bitmap = pbBitmap("Graphics/Titles/Backgrounds/sky")
    @sprites["clouds"] = ScrollingSprite.new(viewport)
    @sprites["clouds"].setBitmap("Graphics/Titles/Panorama/clouds")
    ...
    for i in 1..3
      ...
      @sprites["trees#{m}"].setBitmap(sprintf("Graphics/Titles/Panorama/trees%03d",m))
      @sprites["trees#{m}"].speed = m*2
      @sprites["trees#{m}"].direction = -1
    end
    @sprites["grass"] = ScrollingSprite.new(viewport)
    @sprites["grass"].setBitmap("Graphics/Titles/Panorama/grass")
...
class MTS_Element_BG7
  ...
  def initialize(viewport,file=nil)
    ...
    for j in 0...3
      ...
      @sprites["b#{j}"].setBitmap(sprintf("Graphics/Titles/Particles/ring%03d",j+4),8)
...
class MTS_Element_BG8
  ...
  def initialize(viewport,file=nil)
    ...
    # background graphics
    @sprites["bg1"] = Sprite.new(@viewport)
    @sprites["bg1"].bitmap = pbBitmap("Graphics/Titles/Backgrounds/evolution")
    # particles for the background
    for j in 0...6
      @sprites["l#{j}"] = Sprite.new(@viewport)
      @sprites["l#{j}"].bitmap = pbBitmap("Graphics/Titles/Particles/ray004")
...
class MTS_Element_BG9
  ...
  def initialize(viewport,file=nil)
    ...
    # background graphics
    @sprites["bg1"] = Sprite.new(@viewport)
    @sprites["bg1"].bitmap = pbBitmap("Graphics/Titles/Backgrounds/ethereal")
    # particles for the ripple
    for j in 0...4
      @sprites["r#{j}"] = Sprite.new(@viewport)
      @sprites["r#{j}"].bitmap = pbBitmap("Graphics/Titles/Particles/special005")
      @sprites["r#{j}"].center!
...
class MTS_Element_BG10
  ...
  def initialize(viewport,file=nil)
    ...
    @sprites["streak"].bitmap = pbBitmap("Graphics/Titles/Panorama/streak")
    @sprites["streak"].y = @viewport.rect.height*3
    # silhouette
    @sprites["sil"] = Sprite.new(@viewport)
    @sprites["sil"].bitmap = pbBitmap("Graphics/Titles/Backgrounds/silhouette")
...
class MTS_Element_BG11
  ...
  def initialize(viewport,file=nil)
    ...
    @sprites["bg"].setBitmap("Graphics/Titles/Backgrounds/"+file)
    @sprites["bg"].speed = 1
  end
  # disposes of everything
  def dispose
...
class MTS_Element_BG12
  ...
  def initialize(viewport,file=nil)
    ...
    # creates the background layer
    @sprites["bg"] = Sprite.new(@viewport)
    @sprites["bg"].bitmap = pbBitmap("Graphics/Titles/Backgrounds/crystal")
