...
module Settings
  ...
  ENCRIPTAR_REGALOS_MISTERIOSOS_EN_MASTER = false
  ...
  SHINY_POKEMON_CHANCE = 65 #(MECHANICS_GENERATION >= 6) ? 16 : 8
  ...
  # Interruptor de los super shinys forzados.
