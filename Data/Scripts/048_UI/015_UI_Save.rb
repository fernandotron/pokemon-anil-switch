...
class PokemonSave_Scene
  LOCATION_TEXT_BASE   = Color.new(144, 240, 144)
  LOCATION_TEXT_SHADOW = Color.new(32, 152, 8)   # Green
  MALE_TEXT_BASE       = Color.new(120, 184, 232)
  MALE_TEXT_SHADOW     = Color.new(0, 112, 248)   # Blue
  FEMALE_TEXT_BASE     = Color.new(248, 168, 184)
  FEMALE_TEXT_SHADOW   = Color.new(232, 32, 16)   # Red
  OTHER_TEXT_BASE      = Color.new(120, 184, 232)
  OTHER_TEXT_SHADOW    = Color.new(0, 112, 248)   # Blue
