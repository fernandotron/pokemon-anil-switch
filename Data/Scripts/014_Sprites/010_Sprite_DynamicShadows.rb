...
class Spriteset_Map
  ...
  def initialize(map = nil)
    ...
    if $scene && $scene.respond_to?(:spritesetGlobal) && $scene.spritesetGlobal && $scene.spritesetGlobal.playersprite
      $scene.spritesetGlobal.playersprite.setShadows(map, @shadows) rescue nil
    end
  end
end
