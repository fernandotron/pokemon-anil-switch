...
class MTS_Element_OL1
  ...
  def initialize(viewport,file=nil,z=nil,speed=nil)
    ...
    @sprites["ol"].setBitmap("Graphics/Titles/Overlays/"+file)
...
class MTS_Element_OL4
  ...
  def initialize(viewport,file=nil,z=nil,speed=nil)
    ...
    # creates the background layer
    @sprites["ol"] = ScrollingSprite.new(@viewport)
    @sprites["ol"].setBitmap("Graphics/Titles/Overlays/"+file,true)
...
class MTS_Element_OL5
  ...
  def initialize(viewport,file=nil,z=nil,speed=nil)
    ...
    @sprites["ol"].bitmap = pbBitmap("Graphics/Titles/Overlays/static001")
...
class MTS_Element_OL6
  ...
  def initialize(viewport,file=nil,z=nil,speed=nil)
    ...
    for i in 0...128
      ...
      @sprites["s#{i}"].bitmap = pbBitmap(sprintf("Graphics/Titles/Particles/star%03d",rand(7)+1))
...
class MTS_Element_OL7
  ...
  def initialize(viewport,file=nil,z=nil,speed=nil)
    ...
    for i in 0...3
      ...
      @sprites["o#{i}"].setBitmap("Graphics/Titles/Overlays/waves#{i+1}")
...
class MTS_Element_OLX
  ...
  def initialize(viewport,file=nil,z=nil)
    ...
    # creates the background layer
    @sprites["ol"] = Sprite.new(@viewport)
    @sprites["ol"].bitmap = pbBitmap("Graphics/Titles/Overlays/#{file}")
