...
class Battle::Scene::PokemonDataBox < Sprite
  def draw_special_form_icon
    ...
    pbDrawImagePositions(self.bitmap, [[filename, @spriteBaseX + specialX + correcc_X, specialY + correcc_Y]]) if filename
  end
end
...
class Battle::Scene::Animation::BattlerMegaEvolve < Battle::Scene::Animation
  ...
  def createProcesses
    ...
    if !@battler.wild?
      ...
      delta = (base_width.to_f * 0.75).to_i + 80
