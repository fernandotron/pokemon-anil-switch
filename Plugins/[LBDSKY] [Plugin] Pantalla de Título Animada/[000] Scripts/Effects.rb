  ...
  def update
    ...
    for j in 0...16
      ...
      if @sprites["r#{j}"].opacity <= 0
        bmp = pbBitmap("Graphics/Titles/Particles/ray001")
        w = rand(65) + 16
...
class MTS_Element_FX2
  ...
  def initialize(viewport,x=nil,y=nil,z=nil)
    ...
    for j in 0...20
      ...
      @sprites["s#{j}"].bitmap = pbBitmap("Graphics/Titles/Particles/smoke001")
      @sprites["s#{j}"].center!
...
class MTS_Element_FX3
  ...
  def initialize(viewport,x=nil,y=nil,z=nil)
    ...
    for j in 0...3
      ...
      @sprites["ec#{j}"].bitmap = pbBitmap("Graphics/Titles/Particles/ring002")
      @sprites["ec#{j}"].center!
...
class MTS_Element_FX4
  ...
  def initialize(viewport,x=nil,y=nil,z=nil)
    ...
    for j in 0...8
      ...
      @sprites["r#{j}"].bitmap = pbBitmap("Graphics/Titles/Particles/ray002")
      @sprites["r#{j}"].ox = 0
...
class MTS_Element_FX5
  ...
  def initialize(viewport,x=nil,y=nil,z=nil)
    ...
    for j in 0...16
      @sprites["s#{j}"] = Sprite.new(@viewport)
      @sprites["s#{j}"].bitmap = pbBitmap("Graphics/Titles/Particles/shine001")
      @sprites["s#{j}"].center!
      @sprites["s#{j}"].x = self.x
      @sprites["s#{j}"].y = self.y
      @sprites["s#{j}"].z = z.nil? ? 30 : z
...
class MTS_Element_FX6
  ...
  def initialize(viewport,x=nil,y=nil,z=nil)
    ...
    @sprites["shine2"].bitmap = pbBitmap("Graphics/Titles/Particles/shine002")
...
class MTS_Element_FX7
  ...
  def initialize(viewport,x=nil,y=nil,z=nil)
    ...
    @sprites["shine"].bitmap = pbBitmap("Graphics/Titles/Particles/shine003")
...
class MTS_Element_FX8
  ...
  def initialize(viewport,x=nil,y=nil,z=nil)
    ...
    for i in 0...6
      ...
      @shine["f#{i}"].bitmap = pbBitmap(sprintf("Graphics/Titles/Particles/flare%03d",i+1))
      @shine["f#{i}"].center!
      @shine["f#{i}"].x = 0
      @shine["f#{i}"].y = 0
      @shine["f#{i}"].opacity = 0
    ...
    for i in 0...3
      ...
      @shine["s#{i}"].bitmap = pbBitmap("Graphics/Titles/Particles/ray003")
...
class MTS_Element_FX9
  ...
  def initialize(viewport,x=nil,y=nil,z=nil)
    ...
    @sprites["ele"].bitmap = pbBitmap("Graphics/Titles/Overlays/special001")
    ...
    for i in 0...16
      ...
      @sprites["l#{i}"].bitmap = pbBitmap("Graphics/Titles/Particles/special001")
      @sprites["l#{i}"].center!
    ...
    for i in 0...16
      @sprites["r#{i}"] = Sprite.new(@viewport)
      @sprites["r#{i}"].bitmap = pbBitmap("Graphics/Titles/Particles/special001")
      @sprites["r#{i}"].center!
      @sprites["r#{i}"].opacity = 0
      @sprites["r#{i}"].z = z.nil? ? 30 : z
    end
...
class MTS_Element_FX10
  ...
  def initialize(viewport,x=nil,y=nil,z=nil)
    ...
    for k in 0...@amt*2
      ...
      @sprites["f#{i}"].bitmap = pbBitmap("Graphics/Titles/Particles/special003")
...
class MTS_Element_FX11
  ...
  def initialize(viewport,x=nil,y=nil,z=nil)
    ...
    @sprites["cir"].bitmap = pbBitmap("Graphics/Titles/Particles/radial002")
    @sprites["cir"].center!
...
class MTS_Element_FX12
  ...
  def initialize(viewport,x=nil,y=nil,z=nil)
    ...
    for j in 0...64
      ...
      bmp = pbBitmap("Graphics/Titles/Particles/special004")
