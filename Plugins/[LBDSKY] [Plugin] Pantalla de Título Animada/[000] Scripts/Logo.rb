...
class MTS_Element_Logo
  ...
  def initialize(viewport)
    ...
    @sprites["glow2"].opacity = 0
      # draw bitmap ------------------------------------------------------------
      bmp = pbBitmap("Graphics/Titles/logo2")
    ...
    @sprites["glow1"].opacity = 0
      # draw bitmap ------------------------------------------------------------
      bmp = pbBitmap("Graphics/Titles/logo1")
    ...
    bmp = pbBitmap("Graphics/Titles/logo3")
    ...
    if @sparkle
      for i in 0...12
        ...
        @sprites["s#{i}"].z = 999
        @sprites["s#{i}"].bitmap = pbBitmap("Graphics/Titles/Particles/special002")
        @sprites["s#{i}"].center!
