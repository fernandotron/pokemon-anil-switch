...
module RandomizedChallenge
  ...
  ITEM_BLACK_LIST = [:CENIZASSAGRADAS, :GROWTHMULCH, :BLACKFLUTE, :WHITEFLUTE, :BLUEFLUTE, :YELLOWFLUTE, :REDFLUTE,
                     ...
                     :TINYBAMBOOSHOOT, :BIGBAMBOOSHOOT, :STRAWBERRYSWEET, :LOVESWEET, :BERRYSWEET, :CLOVERSWEET, :FLOWERSWEET, :STARSWEET, :RIBBONSWEET,
                    :DOUSEDRIVE, :SHOCKDRIVE, :BURNDRIVE, :CHILLDRIVE, :FIREMEMORY, :WATERMEMORY, :ELECTRICMEMORY, :GRASSMEMORY, :ICEMEMORY, :FIGHTINGMEMORY,
