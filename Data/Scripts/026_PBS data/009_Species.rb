  ...
  class Species
    ...
    def self.editor_properties
      return [
        ...
        ["Region",            StringProperty,                     _INTL("Número de la región en la que debutó el Pokémon pensado para las formas regionales.")]
      ]
    end
    ...
    def self.get_species_form(species, form)
      ...
      return DATA[species_form] if DATA.has_key?(species_form)
