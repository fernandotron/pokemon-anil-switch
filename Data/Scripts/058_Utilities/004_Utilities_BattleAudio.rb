...
def pbGetWildBattleBGM(_wildParty)
  ...
  if !ret
    if pbResolveAudioBGM("Salvaje")
      ret = pbStringToAudioFile("Salvaje")
    else
...
def pbGetWildVictoryBGM
  ...
  if !ret
    if pbResolveAudioBGM("VictoriaSalvaje")
      ret = pbStringToAudioFile("VictoriaSalvaje")
    else
...
def pbGetTrainerBattleBGM(trainer)
  ...
  if !ret
    if pbResolveAudioBGM("Entrenador")
      ret = pbStringToAudioFile("Entrenador")
    else
