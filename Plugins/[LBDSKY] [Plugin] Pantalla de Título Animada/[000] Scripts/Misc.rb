...
class MTS_Element_MX2
  ...
  def initialize(viewport,x=nil,y=nil,z=nil,s=nil,file=nil)
    ...
    @sprites["poke"].bitmap = pbBitmap("Graphics/Titles/Panorama/pokemon")
...
class MTS_Element_MX3
  ...
  def initialize(viewport,x=nil,y=nil,z=nil,s=nil,file=nil)
    ...
    # initializes pokemon sprite
    @sprites["poke"] = Sprite.new(@viewport)
    @sprites["poke"].bitmap = pbBitmap("Graphics/Titles/Overlays/pokemon")
    @sprites["poke"].z = z.nil? ? 100 : z
    @sprites["poke"].center!
    @sprites["poke"].x = self.x
    @sprites["poke"].y = self.y
    ...
    @sprites["glow"].bitmap = pbBitmap("Graphics/Titles/Overlays/pokemonOverlay")
...
class MTS_Element_MX5
  ...
  def initialize(viewport,x=nil,y=nil,z=nil,s=nil,file=nil)
    ...
    @sprites["poke"] = Sprite.new(@viewport)
    @sprites["poke"].bitmap = pbBitmap("Graphics/Titles/Overlays/#{file}")
    @sprites["poke"].z = z.nil? ? 100 : z
    @sprites["poke"].x = self.x
    @sprites["poke"].y = self.y
  end
...
class MTS_Extra_Overlay
  ...
  def initialize(viewport)
    ...
    for i in 1..26
      ...
      bmp = pbBitmap(sprintf("Graphics/Titles/Intros/cr%03d",i))
